...
const uint32_t STAGE_COL = 2048; // d, 单流精度 2048
...
//    hierarchy::MomentEstimator<On_vHLL> sketchPro(TOP_K, LEVELS, STAGE_NUM, STAGE_ROW, STAGE_COL, rd(), sampling_prob);
    hierarchy::MomentEstimator<Ton_vHLL> sketchPro(TOP_K, LEVELS, STAGE_NUM, STAGE_ROW, STAGE_COL, rd(), sampling_prob);
